...
<tr>
	<td style="padding:30px 0 50px 0">
		<div style="text-align:center">
			...
			{{'@'.$username }} {{ Lang::get('users.you_are_following') }}
			</div>

	<div style="margin:30px 0 35px 0">
		<a href="{{ URL::to('@' . Auth::user()->username) }}/followers" style="display:inline-block;padding:4px 20px;font-weight:bold;line-height:24px;text-decoration:none;color:#f02d00;border:1px solid #f02d00;border-radius:3px" target="_blank">
			{{ Lang::get('users.see_your_followers') }}
			</a>
		</div>
</div>
