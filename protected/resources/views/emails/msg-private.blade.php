...
<tr>
	<td style="padding:30px 0 50px 0">
		<div style="text-align:center">
			...
			{{'@'.$username }} {{ Lang::get('users.send_msg_private') }}
			</div>

	<div style="margin:30px 0 35px 0">
		<a href="{{ URL::to('messages') }}" style="display:inline-block;padding:4px 20px;font-weight:bold;line-height:24px;text-decoration:none;color:#f02d00;border:1px solid #f02d00;border-radius:3px" target="_blank">
