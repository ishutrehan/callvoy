...
================================================== -->
<!-- Category Boxes -->
<div class="section padding-top-65 padding-bottom-65 job_catrgory_section">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<!-- Features Jobs -->
<div class="section dark-gray padding-top-65 padding-bottom-75">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
...
<!-- Features Cities -->
<div class="section padding-top-65 padding-bottom-65 featured_client_area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-list-layout-1.html" class="photo-box" data-background-image="{{ asset('images/featured-city-01.jpg') }}">
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-list-layout-full-page-map.html" class="photo-box" data-background-image="{{ asset('images/featured-city-02.jpg') }}">
                    <div class="photo-box-content">
                        <h3>New York</h3>
                        <span>645 Jobs</span>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-grid-layout-full-page.html" class="photo-box" data-background-image="{{ asset('images/featured-city-03.jpg') }}">
                    <div class="photo-box-content">
                        <h3>Los Angeles</h3>
                        <span>832 Jobs</span>
                    </div>
            ...
            <div class="col-xl-3 col-md-6">
                <!-- Photo Box -->
                <a href="jobs-list-layout-2.html" class="photo-box" data-background-image="{{ asset('images/featured-city-04.jpg') }}">
                    <div class="photo-box-content">
                        <h3>Miami</h3>
                        <span>513 Jobs</span>
                    </div>
...
<div class="section dark-gray padding-top-65 padding-bottom-70 full-width-carousel-fix">
    <div class="container">
        <div class="row">
...
<!-- Membership Plans -->
<div class="section padding-top-60 padding-bottom-75 membership_plans">
    <div class="container">
        <div class="row">
