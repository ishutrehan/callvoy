...
<form class="form-horizontal form-account" method="post" role="form" action="">
			...
			<div class="alert alert-success btn-sm" role="alert">
			 ...
			 <div class="form-group @if( $errors->first('organization_name') ) has-error @endif">
			    ...
			    <div class="col-sm-10">
			      <input type="text" value="{{ $lang->name }}" name="title" class="form-control input-sm" placeholder="{{ Lang::get('misc.title') }}">
			...
			<div class="alert alert-danger btn-sm errors-account" role="alert">
	     	...
	     	@endif
			   ...
			   <div class="form-group @if( $errors->first('organization_name') ) has-error @endif">
			    ...
			    <div class="col-sm-10">
			      <input type="text" maxlength="2" value="{{ $lang->abbreviation }}" name="abbreviation" class="form-control input-sm" placeholder="{{ Lang::get('misc.abbreviation') }} : en">
