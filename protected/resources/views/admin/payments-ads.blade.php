...
@section('title'){{ Lang::get('admin.payments_ads') }}  - @stop
...
@section('content') 
	...
	$payments_all = DB::table('paypal_payments_ads')
...
<div class="panel-body">
	...
	<h4 class="margin-top-zero">
		{{Lang::get('admin.total_earnings')}}: {{$settings->currency_symbol}}{{DB::table('paypal_payments_ads')->sum('payment_amount')}}
		</h4>
