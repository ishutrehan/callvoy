...
@section('content') 
	 ...
	 // ** Sql Query ** //
		...
		->leftjoin('followers as F', 'members.id', '=', DB::raw('F.following AND F.status = "1"'))
...
<h1 class="title-item none-overflow">
	{{ Lang::get('users.following') }} <small>({{ Helper::formatNumber( User::totalFollowing( $user->id ) ) }})</small>
