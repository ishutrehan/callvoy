...
<form action="<?php echo $action; ?>" method="post" name="formpaypal">
	...
	<input type="hidden" name="return" 			value="{{URL::to('/')}}/ads/success">				
	<input type="hidden" name="notify_url" 		value="{{URL::to('/')}}/ads/paypalipn">
	<input type="hidden" name="custom"          value="id_ad={{Input::get('id_ad')}}&token={{Input::get('token')}}&type={{Input::get('type')}}&quantity={{Input::get('quantity')}}">			
	...
	<input type="hidden" name="cancel_return"   value="{{URL::to('my/ads')}}">			
