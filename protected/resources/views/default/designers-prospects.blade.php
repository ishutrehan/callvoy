...
@section('title'){{ Lang::get('misc.designers') }} - {{ Lang::get('misc.prospects') }} -@stop
...
@section('content') 
     ...
     $settings = AdminSettings::first();
		...
		->where('members.type_account',1)
		->where('members.status','active')
		->where('members.team_id',0)
		->groupBy('members.id')
...
<h1 class="title-item none-overflow">
	...
	{{ Lang::get('misc.designers') }} / {{ Lang::get('misc.prospects') }}
	</h1>
<hr />
