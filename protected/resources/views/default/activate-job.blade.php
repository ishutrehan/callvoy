...
<form action="<?php echo $action; ?>" method="post" name="formpaypal">
	...
	<input type="hidden" name="notify_url" 		value="{{URL::to('/')}}/jobs/paypalipnactivate">
	<input type="hidden" name="custom"          value="user_id={{Auth::user()->id}}&token={{$token}}">			
	...
	<input type="hidden" name="cancel_return"   value="{{URL::to('my/jobs')}}">			
